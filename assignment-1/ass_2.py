...
def gradient_descent(weights,i_train,o_train):
	...
	for j in range(0,13):
		...
		for i in range(0,400):
			...
			#print(summ)
			ou_sum += i_summ*(i_train.item((i,j)))
			# print(ou_sum)
...
for i in range(0,100):
	#grad_o=(i_train.transpose()).dot(i_train.dot(weights) - o_train)
	grad_o=gradient_descent(weights,i_train,o_train)
	# print(weights)
	#print(grad_o)
	#print(gradient_descent(weights,i_train,o_train))	
	for j in range(0,13):
